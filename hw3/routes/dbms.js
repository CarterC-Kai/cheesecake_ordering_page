...
var database = "chanc28";  //database name
var user = "chanc28";         //username (change to match your db)
var password = "SBRYDUULNQR";  //password (change to match your db, yes THIS IS VERY POOR PRACTICE)
